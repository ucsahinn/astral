...
- WireSock `-lac` ile scoped sanal ağ arayüzü modunda başlatılır; sanal adaptör hazır olmadan veya WireSock handshake/adapter trafik kanıtı alınmadan bağlantı başarılı sayılmaz.
