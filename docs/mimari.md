...
- WireSock varsayılan transparent mode ile başlatılır; bu modda sanal adaptör tek başına yeterli değildir, WireSock tünel başlangıç onayı bağlantı şartıdır.
...
- Transparent mode WireSock süreci sağlıklı kalsa bile tünel başlangıç onayı yoksa bağlantı başarılı sayılmaz; `wireSockConnectionEstablished=False` hata kanıtıdır.
