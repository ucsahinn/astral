...
> Not: v2.2.26, video/hedef listesi hattını toparladı; hedef testi görsel geri bildirimi, CDN fallback davranışı ve uygulama açma gecikmesi v2.2.27 hotfix ile üstlenildi. Güncel kullanıcılar v2.2.28 veya üstünü kullanmalıdır.
