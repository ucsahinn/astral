...
> Not: v2.2.25 doğru arka plan video paketini yayınladı, ancak aktif hedef listesinde Roblox izleri kaldığı için v2.2.26 tarafından üstlenildi. Güncel kullanıcılar v2.2.26 veya üstünü kullanmalıdır.
