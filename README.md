...
Discorder, Discord uygulaması için hazırlanan dar kapsamlı bir bağlantı aracıdır. Varsayılan kullanımda yalnızca Discord masaüstü uygulamasına odaklanır. Discord Web gerekiyorsa kullanıcı Tarayıcı modunu ayrıca açabilir.
...
| 🌐 Tarayıcı modu | Kullanıcı açarsa Discord Web için bulunan desteklenen tarayıcı executable path'lerini kapsama alır. |
...
| v2.0.30 release notu | [docs/releases/v2.0.30.md](docs/releases/v2.0.30.md) |
