...
<p align="center">
  <a href="https://github.com/ucsahinn/astral/releases">⬇️ İndir</a>
...
Astral, Windows'ta yalnızca kullanıcının seçtiği uygulama veya web hedefleri için bağlantı kapsamı oluşturan portable bir masaüstü uygulamasıdır. Discord, Roblox, Wattpad, Bigo Live, Azar, Tango, LiVU, IMVU, Blogspot ve özel EXE/domain hedefleri seçilebilir.

Astral tüm PC'yi, tüm tarayıcıyı veya sistem genelini VPN'e almayı amaçlamaz. Uygulama hedefleri WireSock `AllowedApps` satırına dar kapsamla yazılır. Web hedeflerinde genel tarayıcı süreçleri profile eklenmez; seçili domainler Astral.WebProxy ve PAC allowlist üzerinden yönlendirilir, diğer domainler DIRECT kalır.
...
Astral, seçili hedef/preset tabanlı bir bağlantı yöneticisidir. Kullanıcı app/web ayrımıyla uğraşmadan hedef seçer; Astral seçimin uygulama, web veya karma kapsamını kendisi çözer.
...
| 🎯 Hedef Merkezi | Presetleri ve özel hedefleri ayrı bir modal içinde seçtirir. |
...
5. Ana ekranda **Hedefleri Seç** ile kapsamı belirleyin.
...
| v2.2.3 release notu | [docs/releases/v2.2.3.md](docs/releases/v2.2.3.md) |
